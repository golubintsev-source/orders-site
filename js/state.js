export const state = {
  ...
  /** фильтр колонки «Дата» доставки: YYYY-MM-DD или null; границы включительно */
  deliveryDateFilterFrom: null,
  deliveryDateFilterTo: null,
  ...
  /** Параметры формулы з/п менеджера: фиксированная сумма (руб.) и процент от стоимости */
  managerSalaryParams: {
    kristina: { base: 22000, percent: 1.5 },
    andrey: { base: 22000, percent: 1.5 },
  },
