...
export const pasteClipboardImageBtn = document.getElementById("pasteClipboardImageBtn");
export const clipboardPasteHint = document.getElementById("clipboardPasteHint");
